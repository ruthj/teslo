...
export const getServerSideProps: GetServerSideProps = async ({req, query}) => {
    ...
    if( !session ){
        return{
            redirect:{
                destination:`/auth/login?p=/orders/${id}`,//la 'p' representa la pagina a la cual sera redirigido
                permanent: false 
            }
        }
    }
    ...
    if ( order.user !== session.user._id ){ //para que el usuario no vea otra ordern
        return{
            redirect:{
                destination: '/orders/history',
                permanent: false 
